<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("datosOut");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid datosOut");
							myInputs[j].focus();
							return false;
						}
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">datosOut</label>
                            		<div class="div_checkbox">
                              		<input name="datosOut" type="checkbox" class="checkbox" id="datosOut" value="${datosOut}" />
                            		</div>
